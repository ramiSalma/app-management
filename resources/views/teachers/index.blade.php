    ...
    <div class="flex flex-wrap gap-4 justify-center">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 p-4">
            <div class="flex flex-col items-center pb-6">
                ...
                <div class="flex mt-4">
                    <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-cyan-600 rounded-lg hover:bg-cyan-700">Delete</a>
                    <a href="#" class="py-2 px-4 ms-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700">Update</a>
                </div>
            </div>
        </div>
        @endforeach
